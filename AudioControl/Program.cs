...
namespace AudioControl
{
    public class Program
	{
		...
		public static void Main(string[] args)
		{
			...
			var devices = deviceManager.ObtainDeviceCollection();
            ...
            if (isCorrect)
            {
                ...
                if (isCorrect)
                {
                    audioDevice = devices.ElementAt(deviceNumber - 1);
                    audioDevice.SetTargetGainForDevice(gain);
                }
            }
            do
            {
                ...
                {
                    case "m":
                        audioDevice.SetMute(true); break;
                    case "u":
                        audioDevice.SetMute(false); break;
                }
            }while (true);
